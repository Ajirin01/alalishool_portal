<li id="question_answer{{$answerId}}li" style="display: flex; justify-content: start">
    <i class="fa fa-circle" style="font-size: .5rem; margin-top: 12px"></i>
    <span class="{{ $correct ? 'text-success' : 'text-danger' }}" id="question_answer{{$answerId}}output" style="margin-left: 5px">
      @php
          echo $answer;
      @endphp
    </span>
    ...
    <div class="action-container" style="margin-left: 30px">
                  ...
                  <div class="row">
                      <div class="col-md-12">
                        <div class="card card-outline card-info">
                          <div class="card-body">
                            <div class="textArea" id="summernote{{$answerId}}question_answer">
                              @php
                                  echo $answer;
                              @endphp
                            </div>
      ...
      <span data-toggle="modal" data-target="#modal-xl{{$answerId}}question_answer"><i class="fa fa-edit" ></i></span>
      {{-- /. edit question answer modal --}}
